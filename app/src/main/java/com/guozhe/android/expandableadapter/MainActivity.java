package com.guozhe.android.expandableadapter;
...
public class MainActivity extends AppCompatActivity {
    private ArrayList<com.guozhe.android.expandableadapter.Group> gData = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exlist_lol = (ExpandableListView) findViewById(R.id.ex_list);


        //数据准备
        gData = new ArrayList<com.guozhe.android.expandableadapter.Group>();
        iData = new ArrayList<ArrayList<Item>>();
        gData.add(new com.guozhe.android.expandableadapter.Group("Ad"));
        gData.add(new com.guozhe.android.expandableadapter.Group("AP"));
        gData.add(new com.guozhe.android.expandableadapter.Group("TANK"));
